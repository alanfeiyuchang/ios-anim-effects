...
extension Effect {
    static let textShimmer = Effect(
        ...
        prompt: L(
            ...
            "处于弱化状态的文字——如“思考中…”标题与“滑动来解锁”胶囊——被一道柔和的斜向光带照亮，光只在字形内部从左向右扫过。文字静止时约为主色30%的不透明度；光带中心提亮到100%，两侧渐隐，以约2.2秒一轮的匀速连续循环穿过文字，不留任何重置痕迹。极光变体中光带带有紫—粉—琥珀的渐变色。整体传达的是冷静、智能的“正在处理”状态，而非生硬的加载转圈。"
        ),
        implementation: L(
