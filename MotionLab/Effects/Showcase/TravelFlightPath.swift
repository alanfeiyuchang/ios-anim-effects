...
extension Effect {
    static let showcaseFlightPath = Effect(
        ...
        prompt: L(
            ...
            "夜景卡片上压着粗体标题“你的下一场冒险，从这里出发”，白色点状航线（1.5pt，虚线 2/6）以 S 形三次贝塞尔横跨卡片。点击后飞机沿曲线 smoothstep 飞行约 3.2 秒，机身对准切线，中段放大到 125% 像在爬升，里程同步累加；24 段橙色尾迹覆盖航线最后约 22%，越往后越细（3.5→1pt）越透明。抵达后停留 400 毫秒再淡出；图钉从 70pt 高处按二次曲线 280 毫秒落下，以指数衰减弹跳（约 13pt，衰减 5/秒）并泛起一圈涟漪。"
        ),
        implementation: L(
