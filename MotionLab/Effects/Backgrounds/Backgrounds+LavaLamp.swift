...
extension Effect {
    static let backgroundsLavaLamp = Effect(
        ...
        prompt: L(
            ...
            "深茄紫色背景，底部泛着柔和暖光。熔化的蜡——自奶油黄经橘红到玫瑰红的纵向渐变——在底部与顶部各积成一池，数颗游离的蜡滴沿漫长而不规则的正弦周期（约 10–25 秒）上浮、下沉并轻轻左右漂移。蜡滴随速度纵向拉长，折返时恢复圆润；与蜡池或彼此相遇时拉出细颈、融为一块光润曲面，再撕裂分开。每颗蜡滴左上方有一抹裁切在蜡体内的柔和高光；液体外缘环绕橙色辉光。点击会加热底部：暖光骤亮后约 1.5 秒内回落，同时指尖下方的蜡池鼓出一颗新蜡滴，约 4.5 秒升到高处，再缓缓沉回池中，黏稠而令人着迷。"
        ),
        implementation: L(
