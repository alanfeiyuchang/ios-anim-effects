...
extension Effect {
    static let cardsShuffle = Effect(
        ...
        prompt: L(
            ...
            "四张支付卡层叠摆放，后方每张依次上移16 pt、缩小6%，顶边错落露出，像一副牌。轻点后最前面的卡片被抽离卡堆约110 pt：它自己走65%，卡堆反向让出35%，保证不出画面；同时以快速弹簧（响应0.32秒、阻尼0.8）上抬24 pt、倾斜8°。300毫秒后第一段弹簧几近到位，卡片层级随即降到最底，再以更柔的弹簧（响应0.55秒、阻尼0.75）滑进最后一位，其余卡片各前进一格并放大补位。两段弹簧首尾交叠，像荷官手里一记利落的洗牌，收尾是一下轻柔触感。"
        ),
        implementation: L(
