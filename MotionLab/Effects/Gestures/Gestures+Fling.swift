...
extension Effect {
    static let gesturesFling = Effect(
        ...
        prompt: L(
            ...
            "一个64 pt的光泽圆球（薄荷绿到天蓝渐变、内高光、同色投影）放在铺着淡点阵的290 pt圆角场地里，按住时1:1跟手并放大到108%。松手后它完整继承离手速度，以0.35秒的时间常数指数减速，大约滑出“速度× 0.35”的距离，身后拖着一道随速度伸缩的淡彗尾。撞墙时速度按0.82的恢复系数反射，圆球贴着接触面压扁最多22%，约120毫秒后复原，重击时伴随轻柔触感。物理逐帧积分，飞行途中一按就能在当前位置稳稳接住；重甩连续反弹，轻抛只滑出一小段。"
        ),
        implementation: L(
