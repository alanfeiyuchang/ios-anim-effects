...
extension Effect {
    static let backgroundsAurora = Effect(
        ...
        prompt: L(
            ...
            "夜空由深海军蓝纵向过渡到青绿，点缀约 70 颗各自以 3–6 秒周期闪烁的星点，底部是深色山脊剪影。四条宽幅强模糊的极光飘带（薄荷绿、青蓝、浅绿、紫粉）横贯天际：每条是两组正弦波叠加的描边曲线，相位以略有差异的速率推进（周期约 8–12 秒），光幕起伏交错、粗细呼吸。飘带叠加混合、两端淡出；每条上方升起一排细密的竖直光柱（间隔 6pt，高为天空的 10%～30%），在飘带边缘最亮并向上渐隐，长短明暗闪烁不定。左右拖动搅动夜空：指尖附近飘带被托起，光柱变长变亮，松手后缓缓回落，静谧而富电影感。"
        ),
        implementation: L(
