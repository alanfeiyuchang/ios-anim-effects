...
extension Effect {
    static let chartsScatterHistogram = Effect(
        ...
        tags: ["scatter plot", "histogram", "unit chart", "morph", "distribution", "散点图", "直方图", "分布", "形变"],
        params: [
