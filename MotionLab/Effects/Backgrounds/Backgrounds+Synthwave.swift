...
extension Effect {
    static let backgroundsSynthwaveGrid = Effect(
        ...
        prompt: L(
            "A retro-futurist 1980s horizon. Upper half: a violet-to-magenta dusk gradient with a large sun whose fill runs from butter yellow to hot pink; horizontal slits cut through its lower half, thin near the centre and thicker toward the horizon, sliding steadily downward. Lower half: a near-black purple floor with a glowing magenta perspective grid — lines converge to a central vanishing point while horizontal rungs rush toward the viewer with correct 1/z spacing, looping seamlessly every rung. Every grid line has a blurred neon bloom beneath a crisp core, the far grid fades into horizon haze, and a hot pink horizon line glows. Speed is constant and hypnotic; the mood is nostalgic, cool and cinematic.",
