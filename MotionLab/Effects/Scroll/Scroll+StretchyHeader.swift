...
extension Effect {
    static let scrollStretchyHeader = Effect(
        ...
        prompt: L(
            ...
            "滚动详情页顶部是一张190 pt的头图——靛蓝、紫、珊瑚与薄荷色的柔和网格渐变，配白色标题——下方内容面板以24 pt圆角顶边压在头图之上。越过顶部继续下拉时，头图固定在顶边并以底边为锚点放大，拉伸填满回弹空隙，松手后随滚动视图原生的橡皮筋效果回弹。向上滚动时头图仅以约50%的速度移动，内容面板从其上方滑过，同时头图逐渐模糊到8 pt。仿佛黏在指尖，饱满、沉浸且高级。"
        ),
        implementation: L(
